	...
	timetableString += '<div class="timetable-week ' + show_time + '">';
		...
		timetableString += '<div class="timetable-columns">';
			...
			for (var m = 0; m < wordDay.length; m++) {
				...
				header_time = (el.attr('data-header-time') == 'hide') ? '' : '';
				...
				timetableString += '<div class="timetable-column">';
					...
					if (screen.width > 768) {
						...
						timetableString += '<div class="timetable-column-header d-flex justify-content-center align-items-center ' + last + '">' + wordDay[m] + header_time + '</div>';
						...
						for (var t = 0; t < timetables.length; t++) {
							...
							if (timetables[t].start_time && timetables[t].end_time) {
								...
								timetableString += 	'<div class="timetable-item">'
														...
														+ '<a class="timetable-title" style="top:' + position + 'px; height:' + height + 'px; ' + item_width + item_left + '" href="#' + el.attr('id') + '-popup-' + timetables[t].id + '" class="open-popup-link">'
														...
														+ '<div id="' + el.attr('id') + '-popup-' + timetables[t].id + '" class="timetable-popup zoom-anim-dialog mfp-hide">'
															...
															+ '<div class="popup-body">'
																...
																+ '<div class="timetable-desc">'
																	...
																	+ '<div class="timetable-sede">Sede: ' + timetables[t].sede + '</div>'
																	+ '<div class="timetable-profesor">Profesor: ' + timetables[t].profesor + '</div>'
																+ '</div>'
